...
public final class MediaControllerCompat {
  ...
  public static MediaControllerCompat getMediaController(Activity paramActivity) {
    ...
    if (paramActivity instanceof SupportActivity) {
      ...
      MediaControllerCompat mediaControllerCompat1 = mediaControllerCompat;
      if (mediaControllerExtraData != null)
        mediaControllerCompat1 = mediaControllerExtraData.getMediaController(); 
      return mediaControllerCompat1;
    } 
    Object object = mediaControllerCompat;
    if (Build.VERSION.SDK_INT >= 21) {
      Object object1 = MediaControllerCompatApi21.getMediaController((Activity)mediaControllerExtraData);
      object = mediaControllerCompat;
      if (object1 != null) {
        object = MediaControllerCompatApi21.getSessionToken(object1);
        try {
...
/* Location:              C:\Workspace\Handsons\Drone\original-drms-app-dex2jar.jar!\android\support\v4\media\session\MediaControllerCompat.class
