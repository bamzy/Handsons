...
public final class PlaybackStateCompat implements Parcelable {
  ...
  public static PlaybackStateCompat fromPlaybackState(Object paramObject) {
    ...
    Bundle bundle = null;
    PlaybackStateCompat playbackStateCompat = new PlaybackStateCompat(PlaybackStateCompatApi21.getState(paramObject), PlaybackStateCompatApi21.getPosition(paramObject), PlaybackStateCompatApi21.getBufferedPosition(paramObject), PlaybackStateCompatApi21.getPlaybackSpeed(paramObject), PlaybackStateCompatApi21.getActions(paramObject), 0, PlaybackStateCompatApi21.getErrorMessage(paramObject), PlaybackStateCompatApi21.getLastPositionUpdateTime(paramObject), (List<CustomAction>)playbackStateCompat, PlaybackStateCompatApi21.getActiveQueueItemId(paramObject), bundle);
    playbackStateCompat.mStateObj = paramObject;
    return playbackStateCompat;
  }
...
/* Location:              C:\Workspace\Handsons\Drone\original-drms-app-dex2jar.jar!\android\support\v4\media\session\PlaybackStateCompat.class
