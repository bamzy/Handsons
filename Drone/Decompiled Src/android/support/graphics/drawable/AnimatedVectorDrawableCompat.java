...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
  ...
  public static void registerAnimationCallback(Drawable paramDrawable, Animatable2Compat.AnimationCallback paramAnimationCallback) {
    if (paramDrawable != null && paramAnimationCallback != null && paramDrawable instanceof android.graphics.drawable.Animatable) {
      if (Build.VERSION.SDK_INT >= 24) {
  ...
  public static boolean unregisterAnimationCallback(Drawable paramDrawable, Animatable2Compat.AnimationCallback paramAnimationCallback) {
    return (paramDrawable != null && paramAnimationCallback != null && paramDrawable instanceof android.graphics.drawable.Animatable) ? ((Build.VERSION.SDK_INT >= 24) ? unregisterPlatformCallback((AnimatedVectorDrawable)paramDrawable, paramAnimationCallback) : ((AnimatedVectorDrawableCompat)paramDrawable).unregisterAnimationCallback(paramAnimationCallback)) : false;
  }
...
/* Location:              C:\Workspace\Handsons\Drone\original-drms-app-dex2jar.jar!\android\support\graphics\drawable\AnimatedVectorDrawableCompat.class
