...
public abstract class AppCompatDelegate {
  ...
  private static AppCompatDelegate create(Context paramContext, Window paramWindow, AppCompatCallback paramAppCompatCallback) {
    ...
    return BuildCompat.isAtLeastN() ? new AppCompatDelegateImplN(paramContext, paramWindow, paramAppCompatCallback) : ((i >= 23) ? new AppCompatDelegateImplV23(paramContext, paramWindow, paramAppCompatCallback) : ((i >= 14) ? new AppCompatDelegateImplV14(paramContext, paramWindow, paramAppCompatCallback) : ((i >= 11) ? new AppCompatDelegateImplV11(paramContext, paramWindow, paramAppCompatCallback) : new AppCompatDelegateImplV9(paramContext, paramWindow, paramAppCompatCallback))));
  }
...
/* Location:              C:\Workspace\Handsons\Drone\original-drms-app-dex2jar.jar!\android\support\v7\app\AppCompatDelegate.class
